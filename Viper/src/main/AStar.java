...
public class AStar {
    ...
    public static void main(String[] args) {
        ...
        double [][] heuristic ={{0, 5, 7, 3, 4, 6, 0, 0, 6, 5, 0},
        {7, 1, 6, 5, 4, 6, 0, 0, 6, 5, 0},
        {4, 3, 6, 7, 4, 6, 0, 0, 6, 5, 0},
        {1, 6, 2, 2, 4, 6, 0, 0, 6, 5, 0},
        {0, 4, 8, 1, 4, 6, 0, 0, 6, 5, 0},
        {6, 2, 4, 7, 4, 6, 0, 0, 6, 5, 0},
        {2, 1, 2, 0, 4, 6, 0, 0, 6, 5, 0},
        {2, 6, 3, 0, 4, 6, 0, 0, 6, 5, 0},
        {5, 5, 3, 2, 4, 6, 0, 0, 6, 5, 0},
        {7, 1, 8, 8, 4, 6, 0, 0, 6, 5, 0},
        {0, 0, 7, 1, 4, 6, 0, 0, 6, 5, 0}};

        int start = 4;
        int goals = 7;
        aStar(maze, heuristic, start, goals);
